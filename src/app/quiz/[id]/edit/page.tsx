...
export default function QuizEditPage() {
  ...
  return (
    ...
    >
      ...
      {/* ─── MOBILE LAYOUT ─────────────────────────────────────────────────────
          pt-[52px]  → clears the fixed top header
          pb-[60px]  → clears the fixed bottom nav
          Only one panel visible at a time (list OR editor)
      ──────────────────────────────────────────────────────────────────────── */}
      <div
        className="flex md:hidden flex-1 flex-col overflow-hidden pt-[52px] pb-[60px]"
        style={{ background: "#0f131c" }}
      >
        {/* LIST PANEL */}
        <div
          className={`flex-1 flex flex-col overflow-hidden ${showEditor ? "hidden" : "flex"}`}
          style={{ background: "#0a0e16" }}
        >
          {/* Header */}
        ...
        {/* EDITOR PANEL */}
        <div
          className={`flex-1 flex flex-col overflow-hidden ${showEditor ? "flex" : "hidden"}`}
          style={{ background: "#0f131c" }}
        >
          {/* ← زر الرجوع — يظهر أسفل الـ top header مباشرة */}
          <button
            onClick={() => setShowEditor(false)}
            className="shrink-0 flex items-center gap-2 px-4 py-3 border-b border-white/5 w-full text-left"
            style={{
              background: "#0d111a",
              color: "#acc7ff",
              fontFamily: "Manrope, sans-serif",
                ...
                <div className="flex flex-col gap-5">
                  <div>
                    ...
                    <textarea
                      value={activeQ.question}
                      onChange={(e) =>
                        updateQuestion(activeQ.id, { question: e.target.value })
                      }
                      rows={3}
                      className="w-full px-4 py-3 rounded-xl text-sm text-[#dfe2ee] placeholder-[#424753] outline-none resize-none transition-all"
                      style={{
                              ...
                              <input
                                ...
                                style={{
                                  background: isCorrect
                                    ? "#45dfa415"
                                    : "#181c24",
                                  border: `1px solid ${isCorrect ? "#45dfa440" : "#424753"}`,
                                  fontFamily: "Manrope, sans-serif",
                                }}
                              />
                            </div>
          ...
          <div className="p-5 border-b border-white/5">
            <div className="flex justify-between items-start gap-2 mb-4">
              ...
              <span
                ...
                style={{
                  background:
                    quiz.status === "published" ? "#45dfa4" + "20" : "#262a33",
                  color: quiz.status === "published" ? "#45dfa4" : "#8c909e",
                  fontFamily: "Manrope, sans-serif",
                }}
              >
                ...
                style={{
                  background:
                    activeQuestion === q.id
                      ...
                      : "#181c24",
                  borderColor:
                    activeQuestion === q.id ? "#acc7ff40" : "#424753" + "40",
                }}
              >
                <div className="flex items-start gap-2.5">
                  <span
